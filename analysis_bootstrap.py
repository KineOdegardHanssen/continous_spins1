...
infile = open("test_binavgs.txt", "r")
...
// Temperature                              // Index 0
            ...
            bootstrapFile << " " << energies[l] << " " << energies_sq[l] << " " << cvs[l]; DONE
...
# Should I work with lists or arrays?

# Make an array for the results from the bootstrap. Should I do it here, or?
# Anyway.
# Or just add and take the average as I go? That may be simplest.
